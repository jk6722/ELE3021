...
#define MAXFILE 10 + 128 + 128 * 128 + 128 * 128 * 128
...
save(char* filename)
{
    ...
    printf(1, "direct blocks success\n");
    ...
    printf(1, "single indirect blocks success\n");
    ...
    printf(1, "double indirect blocks success\n");
    ...
    for (int i = 0; i < 128; i++){
        ...
        printf(1,"write: %d / %d blocks\n", block, MAXFILE);
    }
    printf(1, "triple indirect blocks success\n");
